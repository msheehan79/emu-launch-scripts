...
set emulator_launch="..\emulators\gzdoom\gzdoom.exe" -config ..\configs\ports\gzdoom\%config% -savedir C:\Emulation\saves\doom\doom -iwad C:\Emulation\roms\ports\doom\HERETIC.WAD -file %rom%
