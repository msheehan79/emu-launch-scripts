...
:: Supermodel emulator expects the config files to be relative to the launch directory, so switch to the config file dir
pushd "..\configs\arcade-model3\"
...
set emulator_launch="..\..\emulators\supermodel\supermodel.exe" %rom% %config%
